...
class ReportAccountAgedPartner(models.AbstractModel):
	...
	partner_phone = fields.Char(group_operator='max')
	payment_reference = fields.Char()
	report_date = fields.Date(group_operator=None)
	journal_code = fields.Char(group_operator=None)
	account_code = fields.Char(group_operator=None)
	account_name = fields.Char(group_operator=None)
	...
	def _get_column_details(self, options):
		if options['filter_account_type'] == 'payable':
			columns = [
				self._header_column(),
				self._field_column('payment_reference', name="Payment Reference"),
		...
		elif options['filter_account_type'] == 'receivable':
			columns = [
				self._header_column(),
				self._field_column('partner_phone', name="Phone"),
				self._field_column('report_date'),
				self._field_column('journal_code', name="Journal"),
				self._field_column('account_name', name="Account"),
				self._field_column('expected_pay_date'),
	...
	def _get_hierarchy_details(self, options):
		res = super(ReportAccountAgedPartner,self)._get_hierarchy_details(options)
		return [
